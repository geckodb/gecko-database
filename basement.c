...
static char doc[] =
        "Basement -- a combined database/backend runtime environment that runs JavaScript code server-side.";
...
//
//
//    schema_t *schema = schema_new("usertable");
