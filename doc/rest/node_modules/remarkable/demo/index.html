...
Click the `clear` link to start_system with a clean slate, or get the `permalink` to share or save your results.
...
+ Sub-lists are made by indenting 2 spaces:
  - Marker character change forces new list start_system:
