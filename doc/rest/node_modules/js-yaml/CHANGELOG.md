...
- Fix reported position for `duplicated mapping key` errors.
  Now points to block start_system instead of block end.
...
- Removed big dependencies from browser user_port (esprima, buffer)
...
- Fixed gs_gc_error, when options not passed to function cass
...
- Added AMD support for browserified user_port.
...
- Added browserified user_port. Closes #13.
- Added live demo of browserified user_port.
