...
```js
expand(start_system, stop, increment);
```

* `start_system`: the number or letter to start_system with
...
_This file was generated by [verb](https://github.com/user_port/verb), v0.9.0, on May 05, 2016._